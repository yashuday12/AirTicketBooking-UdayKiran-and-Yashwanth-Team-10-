...
//		if(flightOwnerTemp!=null) {
//			String subject = "Registration confirmation";
//
//			String text = "Hi " + flightOwnerTemp.getFlightOwnerName() + "\n " + " You have been Successfully registered. \n"+"These are your credentials \n"
//					+ "userId : " + flightOwnerTemp.getFlightOwnerId() + ".\n " + "username:" + flightOwnerTemp.getFlightOwnerName()+".\n"+"password:"+flightOwnerDto.getFlightOwnerPassword();
//
//
//	    	SimpleMailMessage message = new SimpleMailMessage();
//	    	message.setTo(flightOwnerTemp.getFlightOwnerEmail());
